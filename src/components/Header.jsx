...
//       to="/"
//       className={({ isActive }) =>
//         isActive ? 'text-green-700 font-semibold text-lg' : 'text-gray-600 hover:text-teal-500'
//       }
//     >
//       Home
//     </NavLink>
...
//           to="/register"
//           className={({ isActive }) =>
//             isActive ? 'text-white bg-teal-600 px-2 py-2 rounded-md shadow-md' : 'text-gray-600 hover:text-teal-500'
//           }
//         >
...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-50 py-4 bg-gray-950">
      <Navbar fluid className="bg-gray-950">
        <Navbar.Brand href="/">
        ...
        <div className="flex md:order-2">
          {!user ? (
            ...
            <Avatar className="mr-2" alt="User settings" img={user.displayImg} rounded />
          )}
